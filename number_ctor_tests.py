...
class NumberCtorTests(unittest.TestCase):
    ...
    def test_parse_binary_positve_number_string(self):
        ...
        self.assertEqual("0x6A3", obj.asHex)
        self.assertEqual("1699", obj.asDecimal)
        self.assertEqual("0o3243", obj.asOctal)
        self.assertEqual(string, obj.asBinary)
    ...
    def test_parse_hex_positve_number_string(self):
        ...
        self.assertEqual(0x6A3, obj.number)
        self.assertEqual(string, obj.asHex)
        self.assertEqual("1699", obj.asDecimal)
        self.assertEqual("0o3243", obj.asOctal)
        self.assertEqual("0b11010100011", obj.asBinary)                
    ...
    def test_parse_octal_positve_number_string(self):
        ...
        self.assertEqual("0x6A3", obj.asHex)
        self.assertEqual("1699", obj.asDecimal)
        self.assertEqual(string, obj.asOctal)
        self.assertEqual("0b11010100011", obj.asBinary)                 
    ...
    def test_parse_decimal_positve_number_string(self):
        ...
        self.assertEqual(0x6A3, obj.number)
        self.assertEqual("0x6A3", obj.asHex)
        self.assertEqual(string, obj.asDecimal)
        self.assertEqual("0o3243", obj.asOctal)
        self.assertEqual("0b11010100011", obj.asBinary)  
